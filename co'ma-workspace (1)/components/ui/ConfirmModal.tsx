...
const ConfirmModal: React.FC<ConfirmModalProps> = ({ isOpen, onClose, onConfirm, title = "تأكيد الحذف", message }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title}>
      <div className="flex flex-col items-center text-center p-4">
        ...
        <div className="flex gap-3 w-full">
           ...
           <Button variant="danger" onClick={() => { onConfirm(); onClose(); }} className="flex-1">حذف نهائي</Button>
        </div>
      </div>
    </Modal>
  );
